class Sample
{
    static void Main()
    {
        ...
        System.Console.WriteLine("The value of o: " + p);

        System.Console.WriteLine("Cost: " + product1.cost);
        System.Console.WriteLine("IVA: " + product1.iva);
        ...
        product2.CalculateIva(in p);
        System.Console.WriteLine("Cost: " + product2.cost);
        System.Console.WriteLine("IVA: " + product2.iva);
        ...
        product3.CalculateIva(in p);
        System.Console.WriteLine("Cost: " + product3.cost);
        System.Console.WriteLine("IVA: " + product3.iva);
